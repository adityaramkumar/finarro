...
import { ArrowLeft, FileText, Scale, AlertTriangle, Users, CreditCard, Shield, Globe } from 'lucide-react';
            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <p className="text-gray-300 leading-relaxed">
                  Welcome to finarro! These Terms of Service ("Terms") govern your use of our financial management 
                  platform and services. By accessing or using finarro, you agree to be bound by these Terms. 
              ...
              <section>
                ...
                <div className="bg-gray-800/50 backdrop-blur border border-gray-700/50 rounded-xl p-6">
                  <p className="text-gray-300 mb-4">
                    finarro provides a comprehensive financial management platform that includes:
                  </p>
                  <ul className="text-gray-300 space-y-3">
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                      <span>Personal financial tracking and budgeting tools</span>
                    </li>
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                    ...
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                      <span>Bank account integration and transaction categorization</span>
                    </li>
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full mt-2 mr-3 flex-shrink-0"></div>
              ...
              <section>
                ...
                <div className="bg-gray-800/50 backdrop-blur border border-gray-700/50 rounded-xl p-6">
                  <p className="text-gray-300 mb-4">You agree NOT to use finarro for any of the following:</p>
                  <ul className="text-gray-300 space-y-3">
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                    ...
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                      <span>Uploading malicious software or harmful content</span>
                    </li>
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                    ...
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                      <span>Interfering with the proper functioning of the service</span>
                    </li>
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <ul className="text-gray-300 space-y-3">
                        <li className="flex items-start">
                          <div className="w-2 h-2 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                          <span>We provide financial information and analysis tools, not financial advice</span>
                        </li>
                        <li className="flex items-start">
                          <div className="w-2 h-2 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                          <span>All financial decisions are your responsibility</span>
                        </li>
                        <li className="flex items-start">
                          <div className="w-2 h-2 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                          <span>We are not liable for any financial losses or decisions</span>
                        </li>
                        <li className="flex items-start">
                          <div className="w-2 h-2 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                          <span>Consult with qualified financial advisors for important decisions</span>
                        </li>
                        <li className="flex items-start">
                          <div className="w-2 h-2 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                          <span>Our AI analysis is for informational purposes only</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-300">
                        All content, features, and functionality of finarro are owned by us and protected by 
                        intellectual property laws. This includes our software, designs, text, and trademarks.
                      </p>
                    </div>
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-2">Your Rights</h3>
                      <p className="text-gray-300">
                        You retain ownership of all financial data and documents you upload to finarro. 
                        You grant us a license to use this data solely to provide our services to you.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <section>
                ...
                <div className="bg-gray-800/50 backdrop-blur border border-gray-700/50 rounded-xl p-6">
                  <p className="text-gray-300 mb-4">
                    finarro is provided "as is" without warranties of any kind. We are not liable for:
                  </p>
                  <ul className="text-gray-300 space-y-3">
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full mt-2 mr-3 flex-shrink-0"></div>
              ...
              <section>
                ...
                <div className="bg-gray-800/50 backdrop-blur border border-gray-700/50 rounded-xl p-6">
                  <div className="space-y-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-2">By Us</h3>
                      <p className="text-gray-300">
                        We may terminate your account if you violate these Terms or engage in 
                        harmful activities. We will provide reasonable notice when possible.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <section>
                ...
                <div className="bg-gray-800/50 backdrop-blur border border-gray-700/50 rounded-xl p-6">
                  <p className="text-gray-300">
                    ...
                    finarro after changes constitutes acceptance of the new Terms.
                  </p>
                </div>
              </section>
