        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <Logo
              className="h-8 w-8"
              showText={true}
              textClassName="text-xl font-bold text-white ml-3"
            />
      ...
      <section className="relative py-16 md:py-24 lg:py-32 overflow-hidden bg-gray-900">
        <div className="relative max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
            Transform how you manage money with AI-powered insights. Chat with
            your finances, connect bank accounts, analyze documents, and make
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-12 mb-20">
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-400 leading-relaxed">
                Our AI categorizes transactions, identifies patterns, and finds
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-400 leading-relaxed">
                Receive personalized recommendations to reduce expenses,
                increase savings, and improve your financial health.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-gray-400 text-xl max-w-3xl mx-auto">
              ...
              financial life with AI assistance
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="group bg-gray-900 p-8 rounded-2xl border border-gray-800 hover:border-indigo-600/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <p className="text-gray-400 leading-relaxed">
                "Why did I spend so much last month?" Get instant answers about
            ...
            <div className="group bg-gray-900 p-8 rounded-2xl border border-gray-800 hover:border-green-600/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <p className="text-gray-400 leading-relaxed">
                Stop manually entering expenses. Connect your accounts once and
            ...
            <div className="group bg-gray-900 p-8 rounded-2xl border border-gray-800 hover:border-purple-600/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <p className="text-gray-400 leading-relaxed">
                "You're spending 40% more on food than similar users." Get
                alerts that actually save you money.
              </p>
            </div>
            ...
            <div className="group bg-gray-900 p-8 rounded-2xl border border-gray-800 hover:border-yellow-600/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <p className="text-gray-400 leading-relaxed">
                Upload receipts, statements, or contracts. AI reads them and
                updates your financial picture automatically.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-gradient-to-r from-indigo-900/50 to-purple-900/50 backdrop-blur border border-indigo-500/20 rounded-3xl p-12 text-center">
            ...
            <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
              Join thousands of people who've already started saving money and
              making smarter financial decisions with finarro.
            </p>
