...
import { Eye, EyeOff, ArrowRight, Bot, ArrowLeft, AlertCircle, CheckCircle2, Loader2, Mail, Lock } from 'lucide-react';
...
const LoginPage = () => {
  ...
  const handleLogin = async (data) => {
    ...
    if (result.success) {
      ...
      if (result.details?.includes('No account found with this email address')) {
        ...
        setServerError('');
      } else if (result.details?.includes('The password you entered is incorrect') || 
