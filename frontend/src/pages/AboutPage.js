            ...
            <section>
              ...
              <div className="bg-gray-800/50 backdrop-blur border border-gray-700/50 rounded-xl p-8">
                <p className="text-gray-300 leading-relaxed mb-6">
                  finarro was born from a simple observation: managing personal
                  finances shouldn't be overwhelming or time-consuming. Founded
                  in 2025, we set out to create a platform that combines the
                  power of artificial intelligence with intuitive design to make
                  financial management accessible to everyone.
                </p>
                <p className="text-gray-300 leading-relaxed">
                  finarro was built with a clear vision: to democratize
                  financial intelligence and help people make better financial
                  decisions through technology. We focus on creating tools that
                  are both powerful and intuitive, ensuring that advanced
                  financial insights are accessible to everyone, regardless of
                  their financial background or experience.
                </p>
              </div>
            </section>
            ...
            <section>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-gray-800/50 backdrop-blur border border-gray-700/50 rounded-xl p-8">
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    To empower individuals with intelligent financial tools that
                    simplify money management, provide actionable insights, and
                    help build lasting financial wellness through innovation and
                    accessibility.
                  </p>
                </div>
                <div className="bg-gray-800/50 backdrop-blur border border-gray-700/50 rounded-xl p-8">
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    A world where everyone has access to personalized financial
                    guidance, where making smart money decisions is effortless,
                    and where financial stress is replaced with confidence and
                    clarity.
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-gray-800/50 backdrop-blur border border-gray-700/50 rounded-xl p-6 hover:bg-gray-800/70 transition-all duration-300 group">
                  ...
                  <p className="text-gray-300 text-sm">
                    Your financial data is sacred. We implement bank-level
                    security measures and maintain the highest standards of data
                    protection.
                  </p>
                </div>
                <div className="bg-gray-800/50 backdrop-blur border border-gray-700/50 rounded-xl p-6 hover:bg-gray-800/70 transition-all duration-300 group">
                  ...
                  <p className="text-gray-300 text-sm">
                    ...
                    We listen, learn, and iterate based on real user feedback.
                  </p>
                </div>
                <div className="bg-gray-800/50 backdrop-blur border border-gray-700/50 rounded-xl p-6 hover:bg-gray-800/70 transition-all duration-300 group">
                  ...
                  <p className="text-gray-300 text-sm">
                    ...
                    insights that were previously available only to financial
                    professionals.
                  </p>
                </div>
                <div className="bg-gray-800/50 backdrop-blur border border-gray-700/50 rounded-xl p-6 hover:bg-gray-800/70 transition-all duration-300 group">
                  ...
                  <p className="text-gray-300 text-sm">
                    Financial wellness should be available to everyone,
                    regardless of income level or financial background. We build
                ...
                <div className="bg-gray-800/50 backdrop-blur border border-gray-700/50 rounded-xl p-6 hover:bg-gray-800/70 transition-all duration-300 group">
                  ...
                  <p className="text-gray-300 text-sm">
                    We believe in clear communication about how we handle your
                    data, what our algorithms do, and how we make money.
                  </p>
                </div>
                <div className="bg-gray-800/50 backdrop-blur border border-gray-700/50 rounded-xl p-6 hover:bg-gray-800/70 transition-all duration-300 group">
                  ...
                  <p className="text-gray-300 text-sm">
                    We're constantly learning and improving. Your financial
                    journey is a marathon, not a sprint, and we're here for the
                    long haul.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gray-800/50 backdrop-blur border border-gray-700/50 rounded-xl p-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <p className="text-gray-300 leading-relaxed">
                      Our sophisticated AI engine analyzes your financial
                      patterns, identifies opportunities for improvement, and
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 leading-relaxed">
                      Automate tedious financial tasks like expense
                      categorization, document processing, and transaction
                      analysis so you can focus on what matters most.
                    </p>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-4">
                    ...
                    <p className="text-gray-300 leading-relaxed">
                      Get a complete picture of your financial health with
                      detailed reports, spending analysis, and trend
                      identification that help you make informed decisions.
                    </p>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-4">
                    ...
                    <p className="text-gray-300 leading-relaxed">
                      Bank-level security, end-to-end encryption, and strict
                      privacy controls ensure your financial data remains safe
            ...
            <section>
              <div className="bg-green-900/20 border border-green-700/50 rounded-xl p-8 text-center">
                ...
                <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                  Have questions about finarro? Want to learn more about our
                  mission? We'd love to hear from you and help you on your
                  financial journey.
                </p>
