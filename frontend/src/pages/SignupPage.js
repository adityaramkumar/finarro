...
import { Eye, EyeOff, ArrowRight, Bot, ArrowLeft, AlertCircle, CheckCircle2, Loader2, Mail, Lock, User } from 'lucide-react';
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
              <button
                type="submit"
                disabled={isLoading || !email || !password || !confirmPassword || !firstName || !lastName || passwordStrength.score < 3}
                className={`group relative w-full flex justify-center items-center py-3 px-4 border border-transparent text-sm font-semibold rounded-xl text-white transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 focus:ring-offset-gray-900 ${
                  isLoading || !email || !password || !confirmPassword || !firstName || !lastName || passwordStrength.score < 3
              ...
              {(!email || !password || !confirmPassword || !firstName || !lastName) && !isLoading && (
