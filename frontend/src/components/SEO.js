...
export const SEOConfigs = {
  ...
  signup: {
    ...
    description: "Join thousands of users who are taking control of their finances with AI-powered insights. Sign up for free and start your journey to financial wellness today.",
    url: "https://finarro.com/signup"
  },
  
  about: {
    title: "About finarro - Our Mission to Democratize Financial Intelligence",
    description: "Learn about finarro's mission to make financial intelligence accessible to everyone through AI technology. Discover our story, values, and vision for the future.",
    url: "https://finarro.com/about",
    structuredData: {
      "@context": "https://schema.org",
      "@type": "AboutPage",
      "name": "About finarro",
      "description": "Learn about finarro's mission to democratize financial intelligence",
      "mainEntity": {
        "@type": "Organization",
        "name": "finarro",
        "url": "https://finarro.com",
  ...
  support: {
    ...
    description: "Get help with finarro. Find answers to common questions, contact our support team, or browse our help documentation. We're here to help you succeed.",
  ...
  privacy: {
    ...
    description: "Learn how finarro collects, uses, and protects your personal and financial information. Read our comprehensive privacy policy and data security practices.",
    url: "https://finarro.com/privacy"
  },
  
  terms: {
    title: "Terms of Service - finarro Legal Terms and Conditions", 
    description: "Read finarro's terms of service, user agreement, and legal conditions. Understand your rights and responsibilities when using our financial management platform.",
