    ...
    <div className="min-h-screen bg-gray-900 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          <div className="mb-8">
            <div className="mb-6">
              <Logo className="h-12 w-12" showText={true} textClassName="text-4xl font-bold text-white ml-4" />
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-400">Your data is protected with enterprise-grade encryption</p>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-400">Connect your accounts for instant financial updates</p>
              </div>
            </div>
          </div>
        </div>
