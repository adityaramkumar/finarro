...
export const transactionsApi = {
  ...
  getTransactionInsights: (params) => api.get('/transactions/insights', { params }),
  searchTransactions: (query) => api.get('/transactions/search', { params: { q: query } })
};
...
export const subscriptionApi = {
  ...
  createSubscription: (paymentMethodId) => api.post('/subscriptions/create', { payment_method_id: paymentMethodId }),
